...
# Configuration
PROJECT_NAME="CapyCard.Desktop"
PROJECT_DIR="CapyCard.Desktop"
APP_EXECUTABLE="CapyCard.Desktop"
APP_BUNDLE_NAME="CapyCard"
BUNDLE_DISPLAY_NAME="CapyCard"
# Icon is in the shared project relative to script execution root (CapyCard/)
PROJECT_ASSETS_PATH="CapyCard/Assets/icon.icns" 
